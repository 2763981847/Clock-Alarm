...
import WorldClockConstants from '@bundle:com.huawei.alarmclock/entry/ets/common/constant/WorldClockConstants';
import ClockArea from '@bundle:com.huawei.alarmclock/entry/ets/view/WorldClock/ClockArea';
import HeaderContainer from '@bundle:com.huawei.alarmclock/entry/ets/view/HeaderContainer';
export default class WorldClockPage extends ViewPU {
            ...
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new HeaderContainer(this, {
                        title: WorldClockConstants.WORLD_CLOCK,
                        closer: () => {
                        }
                    }, undefined, elmtId));
                }
...
//# sourceMappingURL=WorldClockPage.js.map